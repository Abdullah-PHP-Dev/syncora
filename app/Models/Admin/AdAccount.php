...
class AdAccount extends Model
{
    ...
    protected $fillable = ['platform', 'user_id', 'name', 'currency', 'ad_account_id', 'client_id', 'client_secret', 'token_secret', 'status', 'access_token', 'refresh_token', 'expires_at', 'profile_id', 'settings'];
