...
class AdCreative extends Model
{
    ...
    protected $fillable = ['ad_adgroup_id', 'user_id', 'platform', 'social_account_id', 'ad_campaign_id', 'name', 'platform', 'top_snap_media_id', 'brand_name', 'ad_creative_id', 'profile_id',
