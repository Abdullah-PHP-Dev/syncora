                                ...
                                <div class="col-lg-8">
                                    <form id="campaign" enctype="multipart/form-data">
                                        ...
                                        <div class="builder-card">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" name="name" value="{{$campaign->name}}" id="name" class="form-control"
                                                        required>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select id="objective" name="objective" class="form-select" required>
                                                        ...
                                                        <option value="APP_PROMOTION" @if ($campaign->objective == 'APP_PROMOTION') selected @endif>App Promotion</option>
                                                        <option value="SALES" @if ($campaign->objective == 'SALES') selected @endif>Sales</option>
                                                        <option value="LEADS" @if ($campaign->objective == 'LEADS') selected @endif>Leads</option>
                                                        <option value="TRAFFIC" @if ($campaign->objective == 'TRAFFIC') selected @endif>Traffic</option>
                                                    </select>
                                        ...
                                        <div class="builder-card">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" value="{{$campaign->budget}}" name="budget" id="budget"
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" name="start_time" value="{{ \Carbon\Carbon::parse($campaign->start_time)->format('Y-m-d') }}" id="start_time"
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" name="end_time" id="end_time"
                                                        class="form-control" value="{{ \Carbon\Carbon::parse($campaign->end_time)->format('Y-m-d') }}">
                                                ...
                                                <div class="col-md-6 offset-md-6">
                                                    <div class="card shadow-sm border-0">
                                                        <div class="card-body">
                                                            ...
                                                            <hr>
                                                            <input type="hidden" name="final_budget" id="final_budget" value="{{$campaign->budget}}"
                                                                value="">
                                        ...
                                        <div class="builder-card">
                                            ...
                                            <br>
                                            <div class="row bid_amount" @if (!in_array($adGroup->bid_strategy, ['TARGET_COST', 'LOWEST_COST_WITH_MAX_BID'])) style="display:none" @endif>
                                                <div class="col-md-4">
                                        ...
                                        <div class="builder-card">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="creative_type" id="creative_type" class="form-select">
                                                        ...
                                                        <option value="LEAD_GENERATION"  @if ($creative->type == 'LEAD_GENERATION') selected @endif>Lead Generation</option>
                                                        <option value="LENS_DEEP_LINK"  @if ($creative->type == 'LENS_DEEP_LINK') selected @endif>Lens Deep Link</option>
                                                        <option value="WEB_VIEW"  @if ($creative->type == 'WEB_VIEW') selected @endif>Web View</option>
                                                        <option value="LENS_WEB_VIEW"  @if ($creative->type == 'LENS_WEB_VIEW') selected @endif>Lens Web View</option>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="call_to_action" id="call_to_action"
                                                        ...
                                                        <option value="SIGN_UP" @if ($creative->call_to_action == 'SIGN_UP') selected @endif>Sign Up</option>
                                                        <option value="BOOK_NOW" @if ($creative->call_to_action == 'BOOK_NOW') selected @endif>Book Now</option>
                                                        <option value="CONTACT_US" @if ($creative->call_to_action == 'CONTACT_US') selected @endif>Contact Us</option>
                                                        <option value="CALL_NOW" @if ($creative->call_to_action == 'CALL_NOW') selected @endif>Call Now</option>
                                                        <option value="SEND_MESSAGE" @if ($creative->call_to_action == 'SEND_MESSAGE') selected @endif>Send Message</option>
                                                        <option value="DOWNLOAD" @if ($creative->call_to_action == 'DOWNLOAD') selected @endif>Download</option>
                                                    </select>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="url" name="target_link" value="{{$creative->url}}" id="target_link"
                                    ...
                                    <div class="preview-card">
                                        ...
                                        <div class="facebook-preview">
                                            ...
                                            <a id="previewCTA" href="#" target="_blank"
                                                class="btn btn-primary w-100">{{ ucwords(strtolower(str_replace('_', ' ', $ad->call_to_action))) }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@push('scripts')
    <script>
        ...
        var selectedCTA = "{{ $creative->call_to_action }}";
        ...
        if (objectiveSelect) {
            objectiveSelect.addEventListener('change', function() {
                ...
                let promoOptions = promoKeys.map(pKey =>
                    `<option value="${pKey}" ${selectedPromotionType == pKey ? 'selected' : ''}>${config.promotionTypes[pKey].label}</option>`
                ).join('');
                promotionTypeSelect.innerHTML = `<option value="">-- Select Promotion Type --</option>${promoOptions}`;
                promotionTypeSelect.disabled = false;
                console.log('bid strategy', selectedBidStrategy);
                // Populate Bid Strategies
                if (bidStrategySelect) {
                    const bidOptions = config.bidStrategies.map(b =>
                        `<option value="${b}" ${selectedBidStrategy == b ? 'selected' : ''}>${bidStrategyLabels[b] || beautifyLabel(b)}</option>`
                    ).join('');
