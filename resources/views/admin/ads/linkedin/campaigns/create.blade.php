...
@section('title', 'Create LinkedIn Campaign')
...
<style>
    ...
    /* ------------------------------------------------------------------
       LinkedIn ad unit preview - modeled on the real LinkedIn feed card
       for Sponsored Content (Single Image/Video) and the compact sidebar
       layout LinkedIn uses for Text Ads, not a generic "social card".
       Colors/spacing/type match LinkedIn's own UI (#0a66c2 brand blue,
       #f3f2ef card-footer grey, pill-shaped CTA button) rather than the
       Facebook-blue rounded-card look the other builders here use.
       ------------------------------------------------------------------ */
    .linkedin-preview {
        padding: 0;
    ...
    /* Text Ad - LinkedIn's compact right-rail format, a small square
       thumbnail beside two lines of headline text, no media/CTA bar. */
    .li-text-ad {
        display: flex;
        gap: 10px;
        padding: 12px 16px;
            ...
            <div class="authentication-inner">
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <div class="campaign-builder brand-linkedin">
                            <div class="builder-header">
                                <div class="social-icon-mini linkedin">
                                    <i class="bx bxl-linkedin"></i>
                                </div>
                                <h2>Create LinkedIn Campaign</h2>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <form id="campaign" enctype="multipart/form-data">
                                        ...
                                        <!-- ============================================================ -->
                                        <!-- 1. CAMPAIGN INFORMATION (Campaign Group level)                -->
                                        <!-- ============================================================ -->
                                        ...
                                        <!-- ============================================================ -->
                                        <!-- 2. BUDGET, SCHEDULE & BIDDING (Campaign level)               -->
                                        <!-- ============================================================ -->
                                        <div class="builder-card">
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-6">
                                                    <label>Bid Amount (optional - LinkedIn auto-bids if left blank)</label>
                                                    <div class="input-group">
                                                        <span class="input-group-text">{{ $account->currency ?? 'USD' }}</span>
                                        ...
                                        <!-- ============================================================ -->
                                        <!-- 3. AUDIENCE TARGETING (Campaign level)                       -->
                                        <!-- ============================================================ -->
                                        <div class="builder-card">
                                                    ...
                                                    <div class="checkbox-group">
                                                        @foreach (['18-24' => '18 – 24', '25-34' => '25 – 34', '35-54' => '35 – 54', '55+' => '55+'] as $value => $label)
                                                            <div class="form-check form-switch">
                                                                <input class="form-check-input platform-switch" type="checkbox" name="age_range[]" value="{{ $value }}" id="age_{{ $loop->index }}">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="checkbox-group">
                                                        @foreach (['male' => 'Male', 'female' => 'Female'] as $value => $label)
                                                            <div class="form-check form-switch">
                                                                <input class="form-check-input platform-switch" type="checkbox" name="genders[]" value="{{ $value }}" id="gender_{{ $value }}">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            <select name="years_experience_min" id="years_experience_min" class="form-control">
                                                                ...
                                                                @for ($i = 1; $i <= 12; $i++)
                                                                    <option value="{{ $i }}">{{ $i }}{{ $i === 12 ? '+' : '' }} yr</option>
                                                                @endfor
                                                            </select>
                                                    ...
                                                    <div class="platform-group">
                                                        @foreach (['entry' => 'Entry', 'senior' => 'Senior', 'manager' => 'Manager', 'director' => 'Director', 'vp' => 'VP', 'cxo' => 'CXO', 'partner' => 'Partner', 'owner' => 'Owner'] as $value => $label)
                                                            <div class="platform-card">
                                                                <div class="form-check form-switch">
                                                                    <input class="form-check-input platform-switch" type="checkbox" name="seniorities[]" value="{{ $value }}" id="seniority_{{ $value }}">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-12">
                                                    <label>Job Titles (comma-separated, e.g. "Marketing Manager, VP of Sales")</label>
                                                    ...
                                                    <input type="text" name="titles" id="titles" class="form-control" placeholder="e.g. Marketing Manager, VP of Sales">
                                                    <p class="error-message error-titles"></p>
                                                </div>
                                            </div>
                                            <div class="row mt-3">
                                                <div class="col-md-6">
                                                    <label>Industries (comma-separated, e.g. "Computer Software, Biotechnology")</label>
                                                    <input type="text" name="industries" id="industries" class="form-control" placeholder="e.g. Computer Software, Biotechnology">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="platform-group">
                                                        @foreach (['1' => '1', '2-10' => '2-10', '11-50' => '11-50', '51-200' => '51-200', '201-500' => '201-500', '501-1000' => '501-1,000', '1001-5000' => '1,001-5,000', '5001-10000' => '5,001-10,000', '10001+' => '10,001+'] as $value => $label)
                                                            <div class="platform-card">
                                                                <div class="form-check form-switch">
                                                                    <input class="form-check-input platform-switch" type="checkbox" name="company_size[]" value="{{ $value }}" id="company_size_{{ $loop->index }}">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-12">
                                                    <label>Company Names (comma-separated, e.g. "Microsoft, Salesforce")</label>
                                                    ...
                                                    <input type="text" name="employers" id="employers" class="form-control" placeholder="e.g. Microsoft, Salesforce">
                                                    <p class="error-message error-employers"></p>
                                                </div>
                                            </div>
                                            <div class="row mt-3">
                                                <div class="col-md-12">
                                                    <label>Skills (comma-separated, e.g. "Project Management, SQL")</label>
                                                    <input type="text" name="skills" id="skills" class="form-control" placeholder="e.g. Project Management, SQL">
                                        ...
                                        <div class="builder-card">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <select name="creative_type" id="creative_type" class="form-control" required>
                                                        <option value="SPONSORED_CONTENT">Sponsored Content (image/video, shown in-feed)</option>
                                                        <option value="TEXT_AD">Text Ad (small sidebar text ad)</option>
                                                    </select>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="url" name="target_link" id="target_link" class="form-control" placeholder="https://example.com">
                                                    <p class="error-message error-target_link"></p>
                                                </div>
                                            </div>

                                            <div class="mt-4 media-fields">
                                                <div class="duration-buttons">
                                                    <input type="hidden" name="media_type" id="media_type" value="IMAGE">
                                                    <button type="button" class="duration-btn media-type active" data-type="IMAGE">Image</button>
                                                    <button type="button" class="duration-btn media-type" data-type="VIDEO">Video</button>
                                                </div>
                                                <br>
                                            ...
                                            <div class="mt-4">
                                                <label>Ad Text (commentary shown above the media) *</label>
                                                <textarea id="ad_description" name="description" rows="4" class="form-control" maxlength="600"></textarea>
                                        ...
                                        <div class="wizard-step" data-step="5">
                                            <div class="builder-card">
                                                <h5>Review</h5>
                                                <p class="text-muted">Please review your campaign details before launching. It will be created in DRAFT/PAUSED status on LinkedIn - you activate it from the campaign list once you're ready.</p>
                                ...
                                <!-- RIGHT: Preview - mirrors the real LinkedIn ad unit: a
                                     feed card for Sponsored Content, a compact right-rail
                                     widget for Text Ads. Only one is shown at a time,
                                     toggled by the Ad Format select in the Creative step. -->
                                <div class="col-lg-4">
                                    <div class="preview-card">
                                        <div class="preview-header">Live Preview</div>
                                        <div class="linkedin-preview" id="sponsoredPreview">
                                            <div class="li-post">
                                                <div class="li-post-header">
                                                    <div class="li-logo" id="previewLogo">{{ strtoupper(substr($account->name ?? 'C', 0, 1)) }}</div>
                                                ...
                                                <div class="li-commentary" id="previewDescription">Ad text will appear here...</div>
                                                <div class="li-media">
                                                    <img id="previewImage" style="display:none">
                                                    <video id="previewVideo" controls style="display:none"></video>
                                                    <div class="li-media-placeholder" id="previewMediaPlaceholder"><i class="bx bx-image"></i></div>
                                                </div>
                                                <div class="li-cta-bar">
                                                    <div class="li-cta-text">
                                                        <div class="li-cta-headline" id="previewTitle">Campaign Name</div>
                                                        <div class="li-cta-domain" id="previewDomain">yourwebsite.com</div>
                                                    </div>
                                                    <a id="previewCTA" href="#" target="_blank" class="li-cta-btn">Learn more</a>
                                                </div>
                                        ...
                                        <div class="linkedin-preview" id="textAdPreview" style="display:none">
...
@push('scripts')
    <script>
        // See SnapchatAdService's create.blade.php for why this is deferred
        // to `load` rather than running inline - the shared layout's Vue
        // root re-renders #app's server HTML as an in-DOM template once its
        // deferred module script finishes, which would otherwise orphan
        // every listener/querySelector reference attached before that.
        ...
        // ------------------------------------------------------------------
        // CREATIVE TYPE - Sponsored Content needs media, Text Ad doesn't
        // (LinkedIn's TEXT_AD content is inline headline/description/
        // landingPage, no attached image/video asset).
        // ------------------------------------------------------------------
        ...
        function updateCreativeTypeFields() {
            const isTextAd = creativeTypeSelect?.value === 'TEXT_AD';
            if (mediaFields) mediaFields.style.display = isTextAd ? 'none' : '';
            if (mediaInput) mediaInput.required = false; // server enforces this conditionally, not the browser

            // Swap the preview to match the real LinkedIn ad unit for
            // whichever format is selected - a Sponsored Content feed card
            // has no equivalent in the compact Text Ad widget and vice
            // versa, so only one is ever shown.
            if (document.getElementById('sponsoredPreview')) document.getElementById('sponsoredPreview').style.display = isTextAd ? 'none' : '';
            if (document.getElementById('textAdPreview')) document.getElementById('textAdPreview').style.display = isTextAd ? '' : 'none';
        }

        creativeTypeSelect?.addEventListener('change', updateCreativeTypeFields);
        ...
        function calculateBudget() {
            ...
            // Same 15% VAT overlay as the Facebook/Snapchat builders - this
            // is a locally-tracked cost estimate shown to the advertiser
            // (final_budget, stored as the campaign's "budget" for
            // reporting), not something LinkedIn's API is sent: storeAdGroup()/
            // updateAdGroup() send the raw `budget` field to LinkedIn's
            // dailyBudget/totalBudget, VAT-free.
        ...
        document.getElementById('ad_description')?.addEventListener('keyup', function() {
            if (document.getElementById('previewDescription')) document.getElementById('previewDescription').innerText = this.value || 'Ad text will appear here...';
        });
        ...
        targetLinkInput?.addEventListener('input', function() {
            ...
            // LinkedIn's Sponsored Content CTA bar shows the destination's
            // bare domain (eg. "EXAMPLE.COM"), not the full URL.
            if (previewDomain) {
                try {
                    previewDomain.innerText = url ? new URL(url).hostname.replace(/^www\./, '') : 'yourwebsite.com';
                } catch (e) {
                    previewDomain.innerText = 'yourwebsite.com';
                }
            }
        });
        ...
        document.querySelectorAll('.media-type').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                mediaType = this.dataset.type;
                if (document.getElementById('media_type')) document.getElementById('media_type').value = mediaType;

                if (mediaInput) {
                    mediaInput.accept = mediaType === 'VIDEO' ? 'video/*' : 'image/*';
                    document.getElementById('uploadHint').innerText = mediaType === 'VIDEO'
                ...
                if (document.getElementById('previewMediaPlaceholder')) document.getElementById('previewMediaPlaceholder').style.display = '';
            });
        });
        ...
        mediaInput?.addEventListener('change', function(e) {
            ...
            let placeholder = document.getElementById('previewMediaPlaceholder');

            if (placeholder) placeholder.style.display = 'none';

            if (file.type.startsWith('image/')) {
                if (image) { image.src = url; image.style.display = 'block'; }
        ...
        // ------------------------------------------------------------------
        // WIZARD STEP NAVIGATION - same shape as the Snapchat/Facebook
        // builders: each section lives in a .wizard-step[data-step], only
        // one visible at a time, Next/Previous/step pills all drive
        ...
        // A required field on a display:none step can't be natively
        // focused, so browsers silently swallow the submit - validate a
        // step's own fields before letting navigation leave it, while it's
        // still visible and reportValidity() can show the bubble.
        ...
        function populateReviewSummary() {
            ...
            let companySizes = Array.from(document.querySelectorAll('input[name="company_size[]"]:checked'))
                .map(el => el.nextElementSibling.innerText.trim()).join(', ');
            let mediaSummary = mediaInput?.files.length ? '1 file selected' : 'No media';
            ...
            html += reviewRow('Ad Format', beautifyLabel(creativeTypeSelect.value || ''));
        ...
        // scattered across every wizard step - api.js populates them then
        // fires this event. Jump to whichever step holds the first one.
        ...
        // ------------------------------------------------------------------
        // GLOBAL VARIABLES FOR API SUBMISSION - stay outside the load-
        // deferred block above (plain `var`, not scoped) since api.js reads
        // them as globals when #campaign is submitted.
        // ------------------------------------------------------------------
        var url = "{{ route('admin.ads.campaigns.store', ['platform' => 'linkedin']) }}";
