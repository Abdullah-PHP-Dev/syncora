...
@push('scripts')
    <script>
        ...
        var destroyAPIUrl = "{{ route('admin.ads.campaigns.destroy', ['platform' => 'google', 'campaign' => ':API']) }}";
        var statusAPIUrl = "{{ route('admin.ads.campaigns.status', ['platform' => 'google', 'id' => ':API']) }}";
