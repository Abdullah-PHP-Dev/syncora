...
<div class="socialeaz-dash">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="dash-title mb-0"><i class="bx bx-list-ul"></i> Email Lists</h4>
        <button class="dash-btn dash-btn-primary" data-bs-toggle="modal" data-bs-target="#createListModal"><i class="bx bx-plus"></i> New List</button>
    </div>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="dash-card h-100">
                    <div class="d-flex justify-content-between align-items-start">
                        <h6 class="mb-1" style="color:var(--dash-heading);font-weight:600;">{{ $list->name }}</h6>
                        <div class="dropdown">
                    ...
                    <p class="dash-subtitle small mb-3">{{ $list->description ?: 'No description.' }}</p>
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <span class="dash-badge dash-badge-info">{{ $list->subscribers_count }} subscriber{{ $list->subscribers_count === 1 ? '' : 's' }}</span>
                        <span class="dash-subtitle" style="font-size:.7rem;">Created {{ $list->created_at->format('M j, Y') }}</span>
                    </div>
                    <div>
                        <a href="{{ route('admin.email.lists.subscribers.index', $list) }}" class="dash-btn dash-btn-ghost w-100 justify-content-center">Manage Subscribers</a>
                    </div>
                </div>
            </div>
        ...
        @empty
            <div class="col-12">
                <div class="dash-card text-center py-5">
                    <i class="bx bx-list-ul fs-1 d-block mb-2" style="color:var(--dash-muted);"></i>
                    <span class="dash-subtitle">No lists yet. Create one to start adding subscribers.</span>
                </div>
            </div>
        @endforelse
    </div>
